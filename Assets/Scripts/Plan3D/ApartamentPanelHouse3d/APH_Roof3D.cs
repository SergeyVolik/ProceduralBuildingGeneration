...
public class APH_RoofFloor3D : APH_RoofFloor2D, IVisualizer, IFloor3D, IRoof3D
{
    ...
    public APH_RoofFloor3D(APH_RoofFloor2D floor2d, FloorSettings floorSettings, GameObject floorsRoot, GameObject buildingRoot,
    ...
    public void Visualize()
    {
        ...
        for (var i = 0; i < rooms.Count; i++)
        {
            ...
            else if (m_floorNumber-1 == Floor && RoofType == RoofType.FLAT)
            {
                if (rooms[i].RoomType != RoomType.Stairs)
