...
public class APH_BasementFloor3D : APH_BasementFloor2D, IVisualizer, IFloor3D
{
    ...
    public APH_BasementFloor3D(APH_BasementFloor2D floor2d, FloorSettings floorSettings, GameObject floorsRoot, GameObject buildingRoot,
    ...
    public void Visualize()
    {
        ...
        for (var i = 0; i < rooms.Count; i++)
        {
            ...
            if (Floor == 0)
            {
                ...
                else room3d = new APH_Room3d_Stairs(rooms[i], roomRoot, m_buildingRoot, m_panelHouseSettings, _buildingPossiblePrefabs, Floor, m_floorNumber, instantiatedWalls, false, true, RoofType,outerWallMaterial);
            }
